...
const Header = () => {
  return (
    <div className="fixed bottom-0 right-0 lg:top-0 w-full h-auto lg:h-screen lg:w-24 flex flex-col items-center lg:items-center justify-center lg:justify-center pb-8 lg:pb-0 z-50 ">
      <div className=" py-3 lg:py-8 rounded-full border border-[rgba(255,255,255,0.3)] flex flex-row  lg:flex-col items-center justify-center gap-4 duration-200 backdrop-blur-md ">
        {Menus && 
